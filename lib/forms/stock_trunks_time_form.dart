...
class StockTrunksTimeForm extends StatefulWidget {
  const StockTrunksTimeForm({super.key});

  @override
  State<StockTrunksTimeForm> createState() => _StockTrunksTimeFormState();
}

class _StockTrunksTimeFormState extends State<StockTrunksTimeForm> {
    ...
    return BlocListener<CalculateBloc, CalculateState>(
      ...
      child: Column(
        children: [
          ...
          TextWithInputWidget(
            text: 'Количество пожарных стволов',
            controller: countController,
            unit: 'шт',
          ),
          const SizedBox(height: 32),
          TextWithInputWidget(
            text: 'Расход пенообразователя из пенного ствола',
  ...
  void _calculate() {
    final double result = (volumeController.value! * 0.9) /
        (60 * countController.value! * consumptionController.value!);
